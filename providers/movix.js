 ...
 * Generated: 2026-08-01T00:11:42.352102207Z
 */
var __provider = (() => {
  ...
  var PROVIDER_BUDGET_MS, HEADERS, USER_AGENT, BASE_HEADERS, _atob, CODEC_PREFERENCE, B64_ALPHABET, STRICT_QUALITY_TIERS, DEFAULT_QUALITY_TIER, CODEC_PRIORITY, manifestCache, MANIFEST_CACHE_TTL, FETCH_CACHE_TTL, fetchCache, KNOWN_HOST_NAMES, peeledUrls, AD_IFRAME_PATTERNS, VIDEO_IFRAME_SCORE, BASE_URL_FORBIDDEN_PATTERN;
  ...
  function attemptFetch(url, customHeaders, rest) {
    return __async(this, null, function* () {
      const signal = (rest == null ? void 0 : rest.signal) || _currentSignal;
  ...
  var _currentSignal, HEADERS2, RETRY_DELAYS;
  var init_http = __esm({
    "src/movix/http.js"() {
      init_resolvers();
      _currentSignal = null;
  ...
  function searchFallback(baseUrl, tmdbId, mediaType, season, episode) {
    return __async(this, null, function* () {
      ...
      try {
        ...
        const results = (searchData == null ? void 0 : searchData.results) || (Array.isArray(searchData) ? searchData : null);
  ...
  function fetchFallbackStreams(tmdbId, isMovie, season, episodeNum, signal) {
    return __async(this, null, function* () {
      const found = [];
  ...
  function extractStreams(_0, _1, _2, _3) {
    return __async(this, arguments, function* (tmdbId, mediaType, season, episode, options = {}) {
      ...
      if (allStreams.length === 0) {
        ...
        allStreams = yield fetchFallbackStreams(tmdbId, isMovie, season, episodeNum, signal);
        fallbackTried = true;
      }
      if (allStreams.length === 0) {
  ...
  var API_DOMAINS, SITE_ORIGIN, SLOW_HOSTS, FAST_HOSTS, FALLBACK_SOURCES;
