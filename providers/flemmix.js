 ...
 * Generated: 2026-06-23T17:53:10.71519062Z
 */
var __provider = (() => {
  ...
  function detectSubType(tmdbId, mediaType, titles) {
    return __async(this, null, function* () {
      try {
        const details = yield cached(`tmdb_${tmdbId}_${mediaType}`, () => fetchTmdbGenre(tmdbId, mediaType));
  ...
  function resolveWithTimeout(stream) {
    return __async(this, null, function* () {
      try {
        ...
        if (resolved && resolved.url && !resolved.isDirect) return __spreadProps(__spreadValues({}, resolved), { isDirect: true });
        return null;
      } catch (e) {
        return null;
      }
  ...
  function extractSeries(tmdbId, mediaType, titles, season, episode, subType) {
    return __async(this, null, function* () {
      ...
      try {
        ...
        if (imdbId) {
          const absoluteEp = yield getAbsoluteEpisode(imdbId, season, episode);
      ...
      try {
        ...
        const $ = import_cheerio_without_node_native.default.load(epHtml);
        const servers = parseServerTabs(
          $,
