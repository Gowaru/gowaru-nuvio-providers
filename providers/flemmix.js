 ...
 * Generated: 2026-08-25T21:28:14.002293958Z
 */
var __provider = (() => {
  ...
  function fetchJson(_0) {
    return __async(this, arguments, function* (url, options = {}) {
      ...
      return fetchWithRetry(() => __async(null, null, function* () {
        var _a;
        if (isAborted(signal)) throw new Error("AbortError: Request aborted");
        const res = yield safeFetch(url, { headers: mergedHeaders, timeout: (_a = options.timeout) != null ? _a : TIMEOUTS.SEARCH, signal });
        if (!res) throw new Error(`No response from ${url}`);
  ...
  var _currentSignal, HEADERS2, AJAX_HEADERS;
  var init_http = __esm({
    "src/flemmix/http.js"() {
      init_resolvers();
      init_config();
