...
var __provider = (() => {
  ...
  var _currentSignal, rateLimit, DOMAIN, HEADERS2, RETRY_DELAYS;
  var init_http = __esm({
    "src/animesultra/http.js"() {
      init_resolvers();
      _currentSignal = null;
  ...
  function extractStreams(_0, _1, _2, _3) {
    return __async(this, arguments, function* (tmdbId, mediaType, season, episode, options = {}) {
      ...
      const fetchEpisodeServers = (epHref, $context, lang) => __async(null, null, function* () {
        const epRes = yield safeFetch(epHref, { timeout: 1e4, headers: { "User-Agent": USER_AGENT } });
        if (!epRes || !epRes.ok) {
      ...
      const buildEpisodeUrl = (animeUrl, epNum2) => {
        const base = animeUrl.replace(/\.html$/, "");
        return `${base}/episode-${epNum2}.html`;
      };
          ...
          if (!foundServers) {
            ...
            $(".ep-item").each((i, el) => {
              ...
              if (epNum2 && targetNums.includes(epNum2)) {
                const href = $(el).attr("href");
                if (href) epHrefs.push({ epNum: epNum2, href });
              }
            });
