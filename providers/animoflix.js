 ...
 * Generated: 2026-08-28T14:42:07.075126969Z
 */
var __provider = (() => {
  ...
  var rateLimit, _currentSignal, DOMAIN, RETRY_DELAYS2, HEADERS2;
  var init_http = __esm({
    "src/animoflix/http.js"() {
      init_resolvers();
        ...
        for (const sel of selectors) {
          $(sel).each((i, el) => {
            ...
            if (href && href.includes("/anime/") && text.length > 2) {
              ...
              const imgAlt = typeof $(el).closest === "function" ? $(el).closest(".TPost, .TPostMv, article, li, .card, .result-item, .search-item").find("img").first().attr("alt") : null;
  ...
  function normalize(s) {
    return s.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "").replace(/-/g, " ").replace(/[':!.,?()[\]]/g, "").replace(/\b(the|vostfr|vost|vf|french|streaming|anime)\s+/g, "").replace(/\s+/g, " ").trim();
  }
  ...
  function _extractStreams(_0, _1, _2, _3) {
    return __async(this, arguments, function* (tmdbId, mediaType, season, episode, options = {}) {
      var _a;
      ...
      if (!foundMatch) {
        for (let i = 0; i < topCandidates.length && !foundMatch; i++) {
          ...
          try {
            const verifyHtml = yield fetchWithRetry(() => fetchText(`${BASE_URL}/anime/${candidate.slug}/`, { timeout: 8e3 }));
  ...
  var init_extractor = __esm({
    "src/animoflix/extractor.js"() {
      ...
      withCache = createCache("af", "AnimoFlix", { failureTtl: 12e4, maxSize: 200 });
    }
  });
