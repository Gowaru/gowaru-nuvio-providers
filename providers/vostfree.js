 ...
 * Generated: 2026-08-25T23:37:03.813023776Z
 */
var __provider = (() => {
  ...
  var DOMAIN, rateLimit, _currentSignal, HEADERS2, HTTP_SKIP_CODES;
  var init_http = __esm({
    "src/vostfree/http.js"() {
      init_resolvers();
  ...
  function searchAnime(_0) {
    return __async(this, arguments, function* (title, opts = {}) {
  ...
  function extractStreams(_0, _1, _2, _3) {
    return __async(this, arguments, function* (tmdbId, mediaType, season, episode, options = {}) {
      ...
      if (!isAborted(signal) && mediaType === "tv" && effectiveSeason !== void 0 && effectiveSeason !== null && !isBudgetExhausted(startTime, BUDGET_MS)) {
        ...
        if (!hasExplicitSeasonMatch) {
          ...
          if (mainTitle && mainTitle.length >= MIN_QUERY_LENGTH) {
            ...
            const batch = yield searchAnime(seasonQuery, { signal });
      ...
      for (const match of allMatches) {
        ...
        processedCount++;
        try {
          const html = yield fetchText(animeUrl, { signal });
