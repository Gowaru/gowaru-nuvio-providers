 ...
 * Generated: 2026-08-25T22:34:37.239277201Z
 */
var __provider = (() => {
  ...
  function fetchText(_0) {
    return __async(this, arguments, function* (url, options = {}) {
      ...
      if (lastError && (lastError.name === "AbortError" || ((_h = lastError.message) == null ? void 0 : _h.includes("AbortError")))) {
        throw lastError;
      }
      throw lastError || new Error(`Failed after ${retries + 1} attempts: ${url}`);
    });
  }
  var rateLimit, _currentSignal, DOMAIN, RETRY_DELAYS, HEADERS2, AJAX_HEADERS;
  var init_http = __esm({
    "src/streamzo/http.js"() {
      init_resolvers();
      init_config();
  ...
  function findContent(_0, _1, _2) {
    return __async(this, arguments, function* (titles, mediaType, season, opts = {}) {
      var _a;
  ...
  function resolveEmbedToStream(embedUrl, quality, lang, signal) {
    return __async(this, null, function* () {
      if (isAborted(signal)) return null;
      ...
      try {
        const embedHtml = yield fetchText(fullEmbedUrl, { timeout: TIMEOUTS.EMBED, signal });
        if (isAborted(signal)) return null;
  ...
  function extractStreams(_0, _1, _2, _3) {
    return __async(this, arguments, function* (tmdbId, mediaType, season, episode, options = {}) {
      ...
      if (content.type === "movie" || mediaType === "movie") {
        const stream = yield resolveEmbedToStream(content.embedUrl, content.quality, lang, signal);
        if (stream) {
      ...
      if (mediaType === "tv") {
        ...
        if (episodeData) {
          ...
          const stream = yield resolveEmbedToStream(episodeData.embedUrl, content.quality, episodeData.lang, signal);
          if (stream) {
