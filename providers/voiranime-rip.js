 ...
 * Generated: 2026-06-23T17:53:11.206191149Z
 */
var __provider = (() => {
  ...
  function trySearchQuery(query, isFallback = false, originalTitles = null) {
    return __async(this, null, function* () {
      ...
      let scored = results.map((r) => __spreadProps(__spreadValues({}, r), { score: scoreMatch(r.title, query, SCORES) })).filter((r) => r.score >= SCORES.MIN_MATCH).sort((a, b) => b.score - a.score);
  ...
  var import_cheerio_without_node_native2, SEASON_PATTERN;
