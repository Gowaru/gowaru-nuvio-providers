...
<<<<<<< HEAD
 * Generated: 2026-08-27T16:17:12.492432385Z
=======
 * Generated: 2026-08-26T16:18:54.162134121Z
>>>>>>> origin/main
 */
var __provider = (() => {
...
${text}`);
  ...
  function extractStreams(_0, _1, _2, _3) {
    return __async(this, arguments, function* (tmdbId, mediaType, season, episode, options = {}) {
      ...
      const epMeta = !isAborted(signal) && !isBudgetExhausted(startTime, BUDGET_MS) ? yield fetchEpisodeMeta(ep.id, signal) : null;
      let subtitles = [];
