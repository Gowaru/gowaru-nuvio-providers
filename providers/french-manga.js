 ...
 * Generated: 2026-06-23T17:53:10.850190776Z
 */
var __provider = (() => {
  ...
  function fetchCategoryPage(_0) {
    return __async(this, arguments, function* (category, options = {}) {
      yield rateLimit(DOMAIN);
      const url = `${SITE.BASE_URL}/${category}/`;
      const mergedHeaders = __spreadValues(__spreadValues({}, HEADERS2), options.headers || {});
      return fetchWithRetry(() => __async(null, null, function* () {
        var _a;
        const res = yield safeFetch(url, { headers: mergedHeaders, timeout: (_a = options.timeout) != null ? _a : TIMEOUTS.PAGE });
  ...
  function extractSeries(tmdbId, mediaType, titles, season, episode, subType) {
    return __async(this, null, function* () {
      ...
      const match = yield trySearch(titles, targetSeasonNum);
      if (!match) {
