 ...
 * Generated: 2026-02-25T20:33:48.797Z
 */
    ...
    try {
      ...
      for (let i = 0; i < trembedUrls.length; i++) {
        try {
          ...
          const embedHtml = yield fetchText(trembedUrl);
          const $embed = import_cheerio.default.load(embedHtml);
  ...
  return __async(this, null, function* () {
    ...
    for (const match of matches) {
      ...
      for (const ep of targetEpisodes) {
        const episodeUrl = yield findEpisodeUrl(match.url, season, ep);
