 ...
 * Generated: 2026-08-26T15:28:20.606100383Z
 */
var __provider = (() => {
  ...
  function isCloudflareBlock(text) {
    ...
    return text.includes("Cloudflare") || text.includes("challenge-form") || text.includes("Just a moment...") || text.includes("cdn-cgi/bm/cv/") || /Ray ID: [a-f0-9-]{20,}/.test(text);
  }
  function fetchText(_0) {
    return __async(this, arguments, function* (url, options = {}) {
      ...
      const _a = options, { headers: customHeaders, timeout, retries: maxRetriesOpt } = _a, rest = __objRest(_a, ["headers", "timeout", "retries"]);
      const maxRetries = maxRetriesOpt != null ? maxRetriesOpt : 2;
      ...
      for (let attempt = 0; attempt <= maxRetries; attempt++) {
        ...
        if (attempt > 0) {
          const delay = RETRY_DELAYS[attempt - 1] || 2e3;
          yield sleep(delay);
          if (isAborted(signal)) {
            lastError = new Error("AbortError: Request aborted");
            break;
        ...
        try {
          ...
          if (attempt < maxRetries && (((_b = e.message) == null ? void 0 : _b.includes("fetch failed")) || ((_c = e.message) == null ? void 0 : _c.includes("timeout")) || ((_d = e.message) == null ? void 0 : _d.includes("Cloudflare")))) {
            continue;
          }
          throw e;
        }
  ...
  var rateLimit, DOMAIN, HEADERS2, _currentSignal, RETRY_DELAYS;
  var init_http = __esm({
    "src/animevostfr/http.js"() {
      init_resolvers();
      ...
      try {
        ...
        $('.post-title a, .TPost a, .TPostMv a, article a[href*="/animes/"]').each((i, el) => {
          ...
          if (h.includes("/animes/")) {
            const imgAlt = typeof $(el).closest === "function" ? $(el).closest(".TPost, .TPostMv, article").find("img").first().attr("alt") : null;
        ...
        if (results.length === 0) {
          $('.content, #main, main, .result-item, li > a[href*="/animes/"]').each((i, el) => {
            ...
            if (h.includes("/animes/") && t.length > 2) {
              const imgAlt = typeof $(el).closest === "function" ? $(el).closest("li, div").find("img").first().attr("alt") : null;
  ...
  function extractStreams(_0, _1, _2, _3) {
    return __async(this, arguments, function* (tmdbId, mediaType, season, episode, options = {}) {
      ...
      for (const title of uniqueTitles) {
        const results2 = yield searchAnime(title);
