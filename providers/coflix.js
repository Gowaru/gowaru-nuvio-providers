 ...
 * Generated: 2026-06-23T17:53:10.577190456Z
 */
var __provider = (() => {
  ...
  var PROVIDER_BUDGET_MS, RETRY_DELAYS, HEADERS, _atob, CODEC_PREFERENCE, STRICT_QUALITY_TIERS, DEFAULT_QUALITY_TIER, CODEC_PRIORITY, manifestCache, MANIFEST_CACHE_TTL, FETCH_CACHE_TTL, fetchCache, peeledUrls, AD_IFRAME_PATTERNS, VIDEO_IFRAME_SCORE, BASE_URL_FORBIDDEN_PATTERN;
  ...
  function fetchText(_0) {
    return __async(this, arguments, function* (url, options = {}) {
      ...
      return fetchWithRetry(() => __async(null, null, function* () {
        var _a2;
        const res = yield safeFetch(url, { headers: mergedHeaders, timeout: (_a2 = options.timeout) != null ? _a2 : 15e3 });
  ...
  var rateLimit, DOMAIN, BASE_URL, HEADERS2, AJAX_HEADERS;
  var init_http = __esm({
    "src/coflix/http.js"() {
      init_resolvers();
      rateLimit = createProviderRateLimiter();
      DOMAIN = "coflix.cymru";
      BASE_URL = "https://coflix.cymru";
      HEADERS2 = {
  ...
  function probeMovie(slug) {
    return __async(this, null, function* () {
      return cached(`movie_${slug}`, () => __async(null, null, function* () {
        const patterns = [`/film/${slug}/`, `/movie/${slug}/`];
        for (const path of patterns) {
          const url = `${BASE_URL2}${path}`;
          try {
            const html = yield fetchText(url, { timeout: PAGE_TIMEOUT });
            if (html && html.length > 200) {
              const iframeUrl = extractIframeUrl(html);
              if (iframeUrl) {
                console.log(`[Coflix] Found movie at: ${url}`);
                return { url: iframeUrl, lang: extractLanguage(html, url), headers: { Referer: `${BASE_URL2}/`, Origin: BASE_URL2 } };
              }
            }
          } catch (e) {
          }
  ...
  function probeEpisode(slug, season, episode) {
    return __async(this, null, function* () {
      ...
      return cached(cacheKey, () => __async(null, null, function* () {
        const patterns = [
        ...
        for (const pattern of [...new Set(patterns)]) {
          const url = `${BASE_URL2}/episode/${pattern}/`;
          try {
            const html = yield fetchText(url, { timeout: PAGE_TIMEOUT });
  ...
  var BASE_URL2, PAGE_TIMEOUT, CACHE_TTL, cache;
