 ...
 * Generated: 2026-08-26T00:35:44.713544663Z
 */
var __provider = (() => {
  ...
  var import_cheerio_without_node_native, ARM_API, CINEMATA_API, TITLE_NOISE_WORDS;
  var init_dle_extractor = __esm({
    "src/utils/dle-extractor.js"() {
      ...
      TITLE_NOISE_WORDS = /* @__PURE__ */ new Set([
        "saison",
        "saisons",
        "season",
        "seasons",
  ...
  function fetchFromDomain(_0, _1) {
    return __async(this, arguments, function* (domain, path, options = {}) {
      ...
      const isBoston = domain === "coflix.boston";
      const maxRetries = isBoston ? (_a = options.retries) != null ? _a : 1 : 0;
      const timeout = isBoston ? (_b = options.timeout) != null ? _b : 8e3 : 3e3;
      for (let attempt = 0; attempt <= maxRetries; attempt++) {
        ...
        try {
          ...
          if (!res) {
            ...
            if (attempt < maxRetries) yield sleep(RETRY_DELAYS[attempt] || 2e3);
            continue;
          }
  ...
  var rateLimit, _currentSignal, DOMAINS, HEADERS2, AJAX_HEADERS, RETRY_DELAYS;
  var init_http = __esm({
    "src/coflix/http.js"() {
      init_resolvers();
      rateLimit = createProviderRateLimiter();
      _currentSignal = null;
      DOMAINS = ["coflix.boston", "coflix.to", "coflix.cymru", "coflix.fr", "coflix.blog"];
      HEADERS2 = {
        "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/145.0.0.0 Safari/537.36",
    ...
    return __async(this, arguments, function* (tmdbId, mediaType, season, episode, options = {}) {
      ...
      if (mediaType === "movie") {
        for (const title of titles.slice(0, MAX_MOVIE_TITLES)) {
          const candidates = generateSlugCandidates(title, null, (_a = titles._metadata) == null ? void 0 : _a.year).slice(0, MAX_SLUG_CANDIDATES);
      ...
      for (const ep of targetEpisodes) {
        for (const title of titles.slice(0, MAX_SERIES_TITLES)) {
          const candidates = generateSlugCandidates(title, targetSeason, (_b = titles._metadata) == null ? void 0 : _b.year).slice(0, MAX_SLUG_CANDIDATES);
          for (const slug of [...new Set(candidates)]) {
  ...
  var withCache, PAGE_TIMEOUT, MAX_MOVIE_TITLES, MAX_SERIES_TITLES, MAX_SLUG_CANDIDATES;
