...
<<<<<<< HEAD
 * Generated: 2026-08-27T16:17:11.949431856Z
=======
 * Generated: 2026-08-26T16:18:53.972133943Z
>>>>>>> origin/main
 */
var __provider = (() => {
    ...
    return __async(this, arguments, function* (tmdbId, mediaType, season, episodeNum, options = {}) {
      ...
      if (!isBudgetExhausted(startTime, BUDGET_MS) && sagasToFetch.length > 0) {
        for (const sagaUrl of sagasToFetch) {
          ...
          try {
            const html = yield fetchSagaPage(sagaUrl);
  ...
  var init_extractor = __esm({
    "src/sekai/extractor.js"() {
      ...
      BUDGET_MS = 4e4;
      CACHE_TTL = 3e5;
      withCache = createCache("sk", "Sekai", { successTtl: 10 * 6e4, maxSize: 200 });
      SLUG_OVERRIDES = {
        "one-piece": "piece",
        "one piece": "piece",
        "dr-stone": "drstone",
